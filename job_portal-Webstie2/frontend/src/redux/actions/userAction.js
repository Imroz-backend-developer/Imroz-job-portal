...
export const userSignInAction = (user) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://imroz-job-portal-backend-deploye.onrender.com/api/Singin", user);
...
export const userSignUpAction = (user) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://imroz-job-portal-backend-deploye.onrender.com/api/Singup", user);
...
export const userLogoutAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get("https://imroz-job-portal-backend-deploye.onrender.com//api/Logout");
...
export const userProfileAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get("https://imroz-job-portal-backend-deploye.onrender.com/api/me",{
...
export const allUserAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get('https://imroz-job-portal-backend-deploye.onrender.com/api/alluser', {
            headers: { 'Cache-Control': 'no-cache' },
        });
...
export const userApplyJobAction = (job) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://imroz-job-portal-backend-deploye.onrender.com/api/user/jobhistory", job);
...
export const deleteUserAction = (id) => async (dispatch) => {
    try {
        ...
        await axios.delete(`https://imroz-job-portal-backend-deploye.onrender.com/api/user/delete/${id}`);
...
export const getUserDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://imroz-job-portal-backend-deploye.onrender.com/api/User/${id}`, {
            headers: {
...
export const updateUserAction = (userData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`https://imroz-job-portal-backend-deploye.onrender.com/api/User/edit/${userData._id}`, userData, config);
...
export const fetchAdminStats = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get("https://imroz-job-portal-backend-deploye.onrender.com/api/admin/stats",config); // Change the endpoint as needed
        dispatch({
