...
export const jobTypeLoadAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get('https://imroz-job-portal-backend-19.onrender.com/api/type/jobs');
        dispatch({
...
export const createJobTypeAction = (jobtype) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://imroz-job-portal-backend-19.onrender.com/api/type/create", jobtype)
        dispatch({
